...
import { getPressureMm, getTimes } from "../utils/index";
...
const sunriseTime = computed(() => {
  return getTimes(props.weatherInfo?.sys?.sunrise + timezone.value);
})
const sunsetTime = computed(() => {
  return getTimes(props.weatherInfo?.sys?.sunset + timezone.value);
})
</script>
    ...
    <div class="highlights-wrapper">
      ...
      <div class="highlight">
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div v-if="weatherInfo?.main?.feels_like" class="card-small-data">
              <div class="info-main-num">
